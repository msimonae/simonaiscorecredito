...
model_path = os.path.join(current_dir, 'modelo_regressao.pkl')
...
try:
    ...
    print(f"Modelo 'modelo_regressao.pkl' não encontrado no caminho: {model_path}")
    # Handle the missing file situation if necessary (e.g., log, exit, or load a default model)
